...
export const removeSongFromPlaylist = (state: RootStateOrAny, playlistId: string, songId: string): ThunkAction<Promise<void>, {}, {}, AnyAction> => {
    return async (dispatch: ThunkDispatch<{}, {}, AnyAction>): Promise<void> => {
        let currentPlaylists: I_Playlist[] = await getCurrentPlaylists(state);
        ...
        newPlaylist.songs = newPlaylist.songs.filter((song: string) => song !== songId);
